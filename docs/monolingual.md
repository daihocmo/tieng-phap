...
"Quá trình đơn ngữ hóa" là khi bạn chuyển sang làm quen với từ điển đơn ngữ, thường với trợ giúp từ điển song ngữ. Từ điển đơn ngữ là từ điển định nghĩa các từ của ngôn ngữ được định nghĩa ở chính ngôn ngữ ấy. Ví dụ: Từ điển Larousse là từ điển Tiếng Pháp đơn ngữ.

![](img/mono2.webp)

### Tại sao bạn nên sử dụng từ điển đơn ngữ

Từ điển đơn ngữ giúp tránh gây ra những “liên tưởng sai lầm” (false associations) từ Tiếng Việt sang Tiếng Pháp. Nếu bạn không sử dụng từ điển đơn ngữ thì dù ngôn ngữ gốc của bạn là gì đi nữa, việc bạn mắc phải những liên tưởng sai lầm là điều khó tránh khỏi. Không có ngôn ngữ nào có thể thể hiện Tiếng Pháp tốt hơn chính Tiếng Pháp.

### “Những liên tưởng sai lầm” nghĩa là gì?

Các định nghĩa trong các từ điển song ngữ thường tạo ra cảm giác rằng một từ trong Tiếng Pháp “tương đương” trực tiếp với một từ trong Tiếng Việt, trong khi trên thực tế chúng chỉ trùng nhau một phần về nghĩa. Điều này dễ dẫn đến việc người học hiểu sai sắc thái hoặc phạm vi sử dụng của từ. Đây là một ví dụ:
...
(Lấy trực tiếp từ một từ điển Pháp–Việt phổ biến)

Giờ hãy xem định nghĩa đơn ngữ của từ này.

_Lấy từ Larousse_

> **Qui est dans une situation très pénible, qui éprouve une grande souffrance morale ou matérielle.**
> (Người ở trong hoàn cảnh rất đau khổ, chịu sự dày vò lớn về tinh thần hoặc vật chất)

_Và vấn đề trở nên rõ ràng hơn khi bạn chỉ dựa vào bản dịch sang Tiếng Việt._

Nếu bạn chỉ biết từ **misérable** qua các từ như “khốn khổ” hay “đáng thương”, bạn có thực sự nắm được cách người Pháp cảm nhận và sử dụng từ này trong ngữ cảnh thực tế không? Không. Rất có thể là không.

Một lý do khác khiến bạn nên sử dụng các định nghĩa đơn ngữ là vì chúng giúp bạn nghĩ bằng Tiếng Pháp. Như đã nói ở phần trước, không có ngôn ngữ nào có thể mô tả Tiếng Pháp tốt như chính Tiếng Pháp. Định nghĩa từ điển là một cách suy nghĩ về từ. Mình chắc rằng các tác giả của những cuốn từ điển đó đã suy nghĩ kỹ về từng định nghĩa trước khi viết ra nó, vì vậy bằng cách đọc định nghĩa và ghi nhớ nó, bạn sẽ có được cảm giác gì đó _ít nhất gần_ giống với những gì người bản xứ khi nghĩ về từ đó.
...
Đừng hiểu sai ý mình, bạn vẫn có thể hiểu thực sự thông qua Immersion, chỉ là nó sẽ mất nhiều thời gian hơn so với việc bạn học những từ đó thông qua chính định nghĩa bằng Tiếng Pháp.
...
Bạn sẽ học Tiếng Pháp trong một thời gian dài nên có thể Internet của bạn sẽ mất vào thời điểm bạn đang thực hiện Immersion.
...
- **[Offline French Dictionary](https://play.google.com/store/apps/details?id=app.opendict.fr)** (Android, comprehensive offline monolingual)

#### iOS

- **[Dictionnaire Français.](https://apps.apple.com/us/app/dictionnaire-fran%C3%A7ais/id1028390792)**
- [French Dictionary & Thesaurus](https://apps.apple.com/us/app/french-dictionary-thesaurus/id1028391429)

## Tiếp cận từ điển đơn ngữ

### Mình nên bắt đầu như thế nào?

Đọc Tiếng Pháp nhiều hơn. Càng đọc nhiều mình càng cảm thấy quen với Tiếng Pháp viết, khi tra từ thì toàn là đơn ngữ từ đó học được nhiều từ hơn, rồi từ đó khả năng sử dụng từ điển đơn ngữ cũng tốt hơn.

Nó thực sự chỉ đơn giản như vậy. Đọc nhiều hơn = đọc từ điển nhiều hơn vì bạn cần từ điển để đọc Tiếng Pháp (Bất cứ thứ gì, tiểu thuyết, sách, báo, blog)
